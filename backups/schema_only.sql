...
\restrict FcUQoAyvOV2ym2ImQqzT2WOcaLqP8mUvrM8g4CeZ1Pa6hJ5bnKYAUGeyo5klyjx
...
CREATE TABLE public.question_attempt_details (
    ...
    CONSTRAINT question_attempt_details_session_type_check CHECK (((session_type)::text = ANY ((ARRAY['exam'::character varying, 'practice'::character varying, 'review'::character varying])::text[]))),
...
CREATE TABLE public.user_exams (
    ...
    exam_config jsonb,
    CONSTRAINT user_exams_status_check CHECK (((status)::text = ANY ((ARRAY['in_progress'::character varying, 'completed'::character varying, 'abandoned'::character varying])::text[])))
);
...
CREATE TABLE public.users (
    ...
    CONSTRAINT valid_role CHECK (((role)::text = ANY ((ARRAY['admin'::character varying, 'editor'::character varying, 'viewer'::character varying])::text[])))
);
...
--
-- Name: question_attempts question_attempts_exam_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.question_attempts
    ADD CONSTRAINT question_attempts_exam_id_fkey FOREIGN KEY (exam_id) REFERENCES public.user_exams(id) ON DELETE CASCADE;
...
\unrestrict FcUQoAyvOV2ym2ImQqzT2WOcaLqP8mUvrM8g4CeZ1Pa6hJ5bnKYAUGeyo5klyjx
